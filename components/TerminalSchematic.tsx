      ...
      >
        <defs>
          <pattern id="schematic-grid" width="20" height="20" patternUnits="userSpaceOnUse">
            <path d="M 20 0 L 0 0 0 20" fill="none" className="stroke-black/5 dark:stroke-white/5" strokeWidth="0.5" />
          </pattern>
        </defs>
        ...
        <rect
          ...
          strokeWidth="1"
          fill="none"
         className="stroke-black dark:stroke-white schematic-frame-draw"/>

        {/* Technical Corner Brackets */}
        {/* Top-Left */}
        <path d="M 8 20 L 8 8 L 20 8" className="stroke-black dark:stroke-white" strokeWidth="1.5" fill="none" />
        {/* Top-Right */}
        <path d="M 780 8 L 792 8 L 792 20" className="stroke-black dark:stroke-white" strokeWidth="1.5" fill="none" />
        {/* Bottom-Left */}
        <path d="M 8 460 L 8 472 L 20 472" className="stroke-black dark:stroke-white" strokeWidth="1.5" fill="none" />
        {/* Bottom-Right */}
        <path d="M 780 472 L 792 472 L 792 460" className="stroke-black dark:stroke-white" strokeWidth="1.5" fill="none" />

        {/* Header Telemetry Bar Line */}
        <line x1="1" y1="32" x2="799" y2="32" strokeWidth="1"  className="stroke-black dark:stroke-white schematic-line-draw"/>

        {/* Header Bar Telemetry Text */}
        <g className="font-mono text-[9px] fill-[#0A0A0A] dark:fill-white" style={{ fontFamily: 'monospace' }}>
          <text x="14" y="21" fontWeight="bold" fontSize="9" letterSpacing="0.05em">
            SYSTEM TELEMETRY // WORKSTATION TERMINAL [NODE: AG-SYS-01]
          </text>
          <text x="470" y="21" fontSize="8" className="fill-[#525252] dark:fill-[#A3A3A3] hidden sm:inline">
            CPU: ARM64/X86_64
          </text>
          <text x="590" y="21" className="fill-[#525252] dark:fill-[#A3A3A3]" fontSize="8">
            BUS_FREQ: 3.8GHz
          </text>
        ...
        <g strokeWidth="0.75" className="stroke-black dark:stroke-white schematic-line-draw">
        ...
        <g className="fill-[#737373] dark:fill-[#A3A3A3] font-mono text-[7px]" style={{ fontFamily: 'monospace' }}>
        ...
        <rect
          ...
          height="384"
          strokeWidth="1"
         className="stroke-black dark:stroke-white fill-[#FAFAF9] dark:fill-[#0A0A0A] schematic-frame-draw"/>

        {/* Inner Terminal Header Bar */}
        <rect x="29" y="49" width="742" height="26" className="fill-[#F4F4F2] dark:fill-[#1A1A1A]" />
        <line x1="28" y1="75" x2="772" y2="75" strokeWidth="1"  className="stroke-black dark:stroke-white schematic-line-draw"/>

        {/* Terminal Window Controls / Indicators */}
        <g fill="none" className="stroke-black dark:stroke-white" strokeWidth="1">
          <circle cx="44" cy="62" r="3.5" className="fill-white dark:fill-[#1A1A1A]" />
          <circle cx="56" cy="62" r="3.5" className="fill-white dark:fill-[#1A1A1A]" />
          <circle cx="68" cy="62" r="3.5" fill="#0055FF" />
        </g>

        {/* Terminal Window Title */}
        <g className="font-mono fill-[#0A0A0A] dark:fill-white" style={{ fontFamily: 'monospace' }}>
        ...
        <g className="font-mono" style={{ fontFamily: 'monospace' }}>
          ...
          <g className="term-line-1">
            ...
            <text x="210" y="110" fontSize="16" className="fill-[#0A0A0A] dark:fill-white">
              kairoku init --prod
            </text>
          </g>
          ...
          <g className="term-line-2">
            <text x="44" y="150" fontSize="14" className="fill-[#525252] dark:fill-[#A3A3A3]">
              [SYS:001]
            </text>
            <text x="120" y="150" fontSize="14" className="fill-[#0A0A0A] dark:fill-white">
          ...
          <g className="term-line-3">
            <text x="44" y="190" fontSize="14" className="fill-[#525252] dark:fill-[#A3A3A3]">
              [SYS:002]
            </text>
            <text x="120" y="190" fontSize="14" className="fill-[#0A0A0A] dark:fill-white">
          ...
          <g className="term-line-4">
            <text x="44" y="230" fontSize="14" className="fill-[#525252] dark:fill-[#A3A3A3]">
              [SYS:003]
            </text>
            <text x="120" y="230" fontSize="14" className="fill-[#0A0A0A] dark:fill-white">
          ...
          <g className="term-line-5">
            <rect x="44" y="260" width="712" height="70" className="fill-white dark:fill-[#1A1A1A] stroke-black dark:stroke-white" strokeWidth="1" />
            <text x="56" y="286" fontSize="14" fontWeight="bold" className="fill-[#0A0A0A] dark:fill-white">
              DIAGNOSTIC TELEMETRY REPORT:
            </text>
            <text x="56" y="312" fontSize="14" className="fill-[#525252] dark:fill-[#A3A3A3]">
          ...
          <g className="term-line-6">
            ...
            <text x="290" y="380" fontSize="16" className="fill-[#0A0A0A] dark:fill-white">
              sys-status
            </text>
            <text
              x="400"
        ...
        <g strokeWidth="1" fill="none" className="stroke-black dark:stroke-white schematic-bus-draw">
          {/* Right Bus Line */}
        ...
        <line x1="1" y1="444" x2="799" y2="444" strokeWidth="1"  className="stroke-black dark:stroke-white schematic-line-draw"/>
        <g className="font-mono text-[8px] fill-[#525252] dark:fill-[#A3A3A3]" style={{ fontFamily: 'monospace' }}>
          <text x="14" y="462" fontWeight="bold" className="fill-[#0A0A0A] dark:fill-white">
