      ...
      <div className="fluid-container py-3 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex w-full md:w-auto items-center justify-between">
          <div className="flex items-center gap-3">
            <Link 
              href="/" 
              className="font-display font-bold text-sm tracking-wider uppercase text-black dark:text-white hover:text-[#0055FF] transition-colors"
            >
              ABRAHAM GRACE
            </Link>
            <span className="hidden sm:inline-block text-[#737373] dark:text-[#A3A3A3] text-[10px] tracking-widest uppercase border border-black/20 dark:border-white/20 px-1.5 py-0.5 bg-[#F4F4F2] dark:bg-[#262626]">
              SPEC_v2.6
            </span>
          </div>
