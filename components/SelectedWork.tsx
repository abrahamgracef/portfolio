  ...
  return (
    <section id="work" className="w-full border-b border-black dark:border-white py-16 sm:py-20 bg-[#FAFAF9] dark:bg-[#0A0A0A]">
      <div className="fluid-container flex flex-col gap-8">
        ...
        <div className="border border-black dark:border-white p-6 sm:p-8 bg-white dark:bg-[#1A1A1A] space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <div>
              <span className="text-[10px] font-mono tracking-widest text-[#737373] dark:text-[#A3A3A3] uppercase">
                FEATURED ARCHITECTURE
              </span>
              <h2 className="font-display text-2xl sm:text-4xl font-bold uppercase tracking-tight text-black dark:text-white">
                KAIROKU
              </h2>
            </div>
            <span className="font-mono text-xs border border-black/20 dark:border-white/20 px-2.5 py-1 bg-[#F4F4F2] dark:bg-[#262626] text-[#0A0A0A] dark:text-[#FAFAF9] font-semibold">
